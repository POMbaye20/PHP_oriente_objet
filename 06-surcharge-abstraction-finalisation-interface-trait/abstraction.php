...
Commentaires : 
    ...
    - Lorsqu'on on hérite d'une classe abstraite on doit OBLIGATOIREMENT redéfinir les méthodes abstraites.
    
    Le développeur maître (lead dev') qui est au coeur de l'application va obliger les autres dev' à redéfinir les méthodes. Ceci est une bonne pratique dans le cadre d'un travail collaboratif et hiérarchisé.
*/
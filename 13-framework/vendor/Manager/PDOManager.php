...
class PDOManager 
{
    ...
    private function __clone() {}   // En private, on ne peut pas cloner d'objet dans cette classe
    ...
    public function getPdo() {
        ...
        // La classe config a pour mission de nous transmettre les informations de connexion à la BDD. Donc on l'inclue  ici, on l'instancie, et grâce à sa fonction getParametersConnect() (voir fichier app/config.php) on récupère les infos dans $connect.
